...
session()->has("logged_in_affiliate");
...
$result2 = $conn->query("SELECT * FROM `wallet` where `user_id` = '$uid' order by `id` DESC LIMIT 1;");
...
<head>
    ...
    <title>MyCoinMedia | Affiliate User | Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" >
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>/affiliatedashboard">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard/myProfile">
            ...
            <!-- Nav Item - Dashboard -->
            <!-- <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard/myGallery">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item ">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard/companyProfile">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard/myPressRelease">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item ">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard/prHistory">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item ">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard/paymentHistory">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item ">
                <a class="nav-link" href="<?= base_url() ?>/affiliatedashboard/signOut" data-toggle="modal" data-target="#logoutModal">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <a class="nav-link dropdown-toggle" href="<?= base_url();?>/affiliatedashboard/addMoney" id="searchDropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <!-- <i class="fas fa-wallet text-primary"></i> -->
                                
                                <!-- <span class="text-dark fw-bold"><strong>Balance:</strong> $  -->
                                <?php if($result2->num_rows > 0 ) {?>
                                    <?php while($row = $result2->fetch_assoc()) {?>
                                        <?php if(!empty($row['wallet_balance'])){
                                            echo '<span class="text-dark fw-bold"><strong>Balance:</strong> $ '. $row['wallet_balance'] .'.00 </span>';
                                        }else{
                                            echo '<span class="text-dark fw-bold">+ Add Money</span>';
                                        }
                                        ?>
                                ...
                                <img src="<?= base_url() ?>/public/assets/user/images/dollar_wallet.png" alt="dollar wallet" width="50px">
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php }elseif(!empty($image_user) && empty($name)){ ?>
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Affiliate User</span>
                                    <img class="img-profile rounded-circle" src="<?= base_url(); ?>/public/uploads/<?= $image_user; ?>">
                                <?php }elseif(empty($image_user) && !empty($name)){ ?>
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $name; ?></span>
                                    <img class="img-profile rounded-circle" src="<?= base_url(); ?>/public/assets/admin/images/undraw_profile.svg" alt="profile">
                                <?php }else{ ?>
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Affiliate User</span>
                                    <img class="img-profile rounded-circle" src="<?= base_url(); ?>/public/assets/admin/images/undraw_profile.svg" alt="profile">
                                <?php } ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="<?= base_url(); ?>/affiliatelogout">Logout</a>
                    </div>
                </div>
            </div>
        </div>
