            ...
            <div class="table-responsive">
                <table id="myTable" class="display text-dark">
                    ...
                    <tbody>
                        ...
                        <?php $sno = 1; foreach ($press as $key) { ?>
                            ...
                            <tr>
                                ...
                                <td><?= $key['status']; ?></td>
                                <td>
                                    <a href="<?= base_url(); ?>/view/<?= $key['release_number'];?>" class="btn btn-primary btn-sm" >View</a>
                                    <a href="<?= base_url(); ?>/addCompanyLink/<?= $key['release_number'];?>" class="btn btn-primary btn-sm">Company link</a>
                                    <a href="<?= base_url(); ?>/addNote/<?= $key['release_number'];?>" class="btn btn-primary btn-sm">Add Note</a>
                                </td>
                                <td><?= $key['note']; ?></td>
                            </tr>
                        <?php $sno++; } ?>
