...
<body>
    <div class="container">
    <h1 class="center">Stripe Payment Page</h1>
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" action="<?php echo base_url('payment');?>" method="post"
                            ...
                            <input type="hidden" name="pro_id" value="<?php echo $key['id'];?>">
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-danger btn-lg btn-block" type="submit">Pay <?php echo '$'.$key['price']; ?> </button>
                                </div>
                            </div>
                            <?php // } ?>
                        </form>
