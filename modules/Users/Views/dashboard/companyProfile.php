...
<!-- DataTales Example -->
<div class="container">
    <?php if(session()->getFlashdata('add-company')):?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong><?= session()->getFlashdata('add-company'); ?></strong>
         ...
         <div class="modal fade" id="companyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url();?>/userdashboard/companyProfile" method="post">
                    ...
                    <?php $sno = 1;?>
                        <?php foreach($users as $key) {?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url(); ?>/userdashboard/editCompanyData/<?= $key['user_id'] ?>" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="<?= base_url(); ?>/userdashboard/viewCompanyData/<?= $key['user_id'] ?>" class="btn btn-primary btn-sm">View</a>
                                </td>
                            </tr>
