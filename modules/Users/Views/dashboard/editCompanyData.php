...
<div class="container">
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex justify-content-end">
                    <a href="<?= base_url(); ?>/userdashboard/companyProfile" class="btn btn-primary btn-md">Back</a>
                </div>
            </div>
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url(); ?>/userdashboard/updateCompanyData/<?= $key['user_id']?>" method="post">
                <div class="row">
