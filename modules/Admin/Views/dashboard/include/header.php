...
session()->has("logged_in_admin");
$user = $_SESSION['logged_in_admin'];
$uid = $user['user_id'];
// var_dump($uid);
// exit;
...
<head>
    ...
    <title>MyCoinMedia | Admin | Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">view User data:</h6>
                        <a class="collapse-item" href="<?= base_url(); ?>/dashboard/userOrderHistory">Order History</a>
                        <a class="collapse-item" href="<?= base_url(); ?>/dashboard/userProfileData">Profile Data</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <i class="fas fa-fw fa-cog"></i>
                    <span>Affiliate Users Data</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">view affliate user data:</h6>
                        <!-- <a class="collapse-item" href="#"></a> -->
                        <a class="collapse-item" href="<?= base_url(); ?>/dashboard/affiliateOrderHistory">Order History</a>
                        <a class="collapse-item" href="<?= base_url(); ?>/dashboard/affiliateProfileData">Profile Data</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Produts Data:</h6>
                        <a class="collapse-item" href="<?= base_url(); ?>/dashboard/addProducts">Add Products</a>
                        <a class="collapse-item" href="<?= base_url();?>/dashboard/products">Edit / Delete Products</a>
                    </div>
                </div>
            </li>
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>/dashboard/addProducts">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Add Products</span>
                </a>
            </li> -->

            <!-- Nav Item - Add New Admin -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>/dashboard/addAdmin">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>/dashboard/pressRelease">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item ">
                <a class="nav-link" href="<?php echo base_url() ?>/userdashboard/signOut" data-toggle="modal" data-target="#logoutModal">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url(); ?>/public/assets/admin/images/undraw_profile_1.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url(); ?>/public/assets/admin/images/undraw_profile_2.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?= base_url(); ?>/public/assets/admin/images/undraw_profile_3.svg" alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <!-- Admin User name and profile picture -->
