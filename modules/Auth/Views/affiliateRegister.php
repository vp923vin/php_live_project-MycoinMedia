...
<head>
    ...
    <title>MyCoinMedia | Affiliate User Registration</title>
</head>
...
<div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6">
                <h3>Register</h3>
                <form id="registerForm" method="post" action="<?php echo base_url('login') ?>">
                    <!-- Name input -->
                    ...
                    <input type="hidden" name="user_role" value="affiliate" />
                    <!-- input -->
                    <!-- <div class="form-outline mb-4">
