...
<head>
    ...
    <title>MyCoinMedia | Reset Password</title>
</head>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6">
                ...
                <form method="post" id="resetPasswordForm" class="form" action="<?= base_url();?>/updatePassword">
                    <!-- Select option input -->
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="password" id="new_password" name="user_password" class="form-control" required/>
                    </div>
